...
public class TraineeDAOTest {
    ...
    public void testFindTraineeByUserUserName() {
        ...
        Optional<Trainee> foundTrainee = Optional.ofNullable(traineeService.selectTraineeByUserName("testUsername"));
    ...
    public void testDeleteTraineeByUserUserName() {
        ...
        traineeService.deleteTraineeByUserName("testUsername");
